...
const OrderScreen = (props) => {
  ...
  useEffect(() => {
    const addPayPalScript = async () => {
      const {data} = await Axios.get('/api/config/paypal'); // data contain client id
      // create a script element and set this script element to paypal sdk
      const script = document.createElement('script');
      script.type = 'text/javascript';
      script.src = `https://www.paypal.com/sdk/js?client-id=${data}`;
      script.async = true;
      //onload happens when this script download in your browser and it's ready to use;
      script.onload = () => {
        setSdkReady(true);
      };
