...
export const createOrder = (order) => async (dispatch, getState) => {
    ...
    try{
        ...
        dispatch({
            // go to cart reducer and set CART_EMPTY state, set cartItems:[]
            type: CART_EMPTY
        });
